...
public class ElasticJobHandler {
    ...
    private static LiteJobConfiguration.Builder simpleJobConfigBuilder(
            String jobName, Class<? extends SimpleJob> jobClass,
        ...
        return LiteJobConfiguration.newBuilder(
                new SimpleJobConfiguration(JobCoreConfiguration.newBuilder(
                        jobName, cron, shardingTotalCount).jobParameter(id).build()
    ...
    public void addJob(String jobName, String cron, Integer shardingTotalCount, String id) {
        ...
        new SpringJobScheduler(new MyJob(), registryCenter, jobConfig, jobEventConfiguration, elasticJobListener).init();
    }
}
